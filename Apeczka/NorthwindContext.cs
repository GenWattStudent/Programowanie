...
public partial class NorthwindContext : DbContext
{
    ...
    public virtual DbSet<AvgvalueOfOrder> AvgvalueOfOrders { get; set; }

    public virtual DbSet<Category> Categories { get; set; }

    public virtual DbSet<CategorySalesFor1997> CategorySalesFor1997s { get; set; }

    public virtual DbSet<CountOrdersValue> CountOrdersValues { get; set; }
    ...
    public virtual DbSet<CustomersWithHigherValueOfOrderInThierCity> CustomersWithHigherValueOfOrderInThierCities { get; set; }
    ...
    public virtual DbSet<QuantityOfEmployeeAcceptedOrder> QuantityOfEmployeeAcceptedOrders { get; set; }
    ...
    public virtual DbSet<WartKazdegoZam> WartKazdegoZams { get; set; }

    public virtual DbSet<WartoscZam> WartoscZams { get; set; }

    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=LAPTOP-HA5MSFQO\\SQLEXPRESS;Database=Northwind;Integrated Security=True;Connect Timeout=30;Encrypt=False;ApplicationIntent=ReadWrite;MultiSubnetFailover=False;TrustServerCertificate=True;");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<AvgvalueOfOrder>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("AVGValueOfOrders");

            entity.Property(e => e.AvgvalueOforders)
                .HasColumnType("money")
                .HasColumnName("AVGValueOFOrders");
        });
        ...
        modelBuilder.Entity<CountOrdersValue>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("CountOrdersValue");
        ...
        modelBuilder.Entity<CustomersWithHigherValueOfOrderInThierCity>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("CustomersWithHigherValueOfOrderInThierCity");
        ...
        modelBuilder.Entity<QuantityOfEmployeeAcceptedOrder>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("QuantityOfEmployeeAcceptedOrders");
        ...
        modelBuilder.Entity<WartKazdegoZam>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("WartKazdegoZam");

            entity.Property(e => e.OrderId).HasColumnName("OrderID");
            entity.Property(e => e.Wartosc).HasColumnType("money");
        });

        modelBuilder.Entity<WartoscZam>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("wartoscZam");
